...
const CustomerLogin = asyncHandler(async (req, res) => {
    ...
    try {
       ...
       cl.CUST_DEPT_ID, cl.LOGIN_TYPE, cl.ACTIVE, cd.CUST_DEPT_NAME, cd.SHORT_NAME AS DEPT_SHORT_NAME,
       c.SHORT_NAME AS CUST_SHORT_NAME
        ...
        const result = await db.executeQuery(query, { CUST_USER_ID, CUST_PASSWORD }, "siri_db");
